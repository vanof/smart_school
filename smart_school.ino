...
//byte mac[] = {0xDE, 0xAD, 0xBE, 0xEF, 0xFE, 0xED}; 	//тестовый мак адрес
//byte mac[] = {0x00,0x01,0x02,0x03,0x04,0x05};			//первый этаж
//byte mac[] = {0x06,0x07,0x02,0x03,0x04,0x05}; 		//второй этаж
byte mac[] = {0x02,0x04,0x02,0x03,0x04,0x05}; 			//третий этаж
