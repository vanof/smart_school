...
//String apiKeyValue = "tPmAT5Ab3j7D9";
//String apiKeyValue = "tPmAT5Ab3j7G9";

//byte mac[] = {0x00, 0xAC, 0xBB, 0xCA, 0xDE, 0x03};
...
/*
  if (client.connect(server, 80)) {
      Serial.println("Connected to server first");
  } else {
    // if you couldn't make a connection:
    Serial.println("connection first failed");
}*/
}
...
void loop() {  
 ...
 // client.stop();
  ...
  if (client.connect(server, 80)) {
      ...
      client.println("Host: smart.156.moscow");
